...
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
	 ...
	 * either use this or {@link #channelFactory(ChannelFactory)} if your
	 ...
	 * when calling {@link #bind()}. This method is usually only used if
	 * {@link #channel(Class)} is not working for you because of some more complex
	 * needs. If your {@link Channel} implementation has a no-args constructor, its
	 * highly recommend to just use {@link #channel(Class)} for simplify your code.
	 */
	...
	/**
	 * Return the configured {@link EventLoopGroup} or {@code null} if non is
	 * configured yet.
	 */
	...
	private static final class BootstrapChannelFactory<T extends Channel> implements ChannelFactory<T> {
		...
		// 通过反射，创建channel(NioServerSocketChannel.class)方法传入的Channel实例
		@Override
		public T newChannel() {
			try {
