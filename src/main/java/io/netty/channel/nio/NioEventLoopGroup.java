 ...
 */
/**
 * 实际上是Reactor线程池，负责调度和执行客户端的接入、网路读写事件的处理、用于自定义任务和定时任务的执行。
 * 
...
public class NioEventLoopGroup extends MultithreadEventLoopGroup {
	 ...
	 * {@link ThreadFactory} and the {@link SelectorProvider} which is returned by
	...
	public NioEventLoopGroup(int nThreads, ThreadFactory threadFactory, final SelectorProvider selectorProvider, final SelectStrategyFactory selectStrategyFactory, final RejectedExecutionHandler rejectedExecutionHandler) {
