...
public abstract class ByteToMessageCodec<I> extends ChannelDuplexHandler {
	...
	/**
	 * see {@link #ByteToMessageCodec(boolean)} with {@code true} as boolean
	 * parameter.
	 */
	...
	/**
	 * see {@link #ByteToMessageCodec(Class, boolean)} with {@code true} as boolean
	 * value.
	 */
	 ...
	 *
	 * @param preferDirect
	 *            {@code true} if a direct {@link ByteBuf} should be tried to be
	 *            used as target for the encoded messages. If {@code false} is used
	 *            it will allocate a heap {@link ByteBuf}, which is backed by an
	 *            byte array.
	 */
	...
	/**
	 * Returns {@code true} if and only if the specified message can be encoded by
	 * this codec.
	 *
	 * @param msg
	 *            the message
