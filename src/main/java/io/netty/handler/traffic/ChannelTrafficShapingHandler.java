...
public class ChannelTrafficShapingHandler extends AbstractTrafficShapingHandler {
	 ...
	 *            0 if no stats are to be computed.
	 * @param maxTime
	...
	/**
	 * Create a new instance using default max time as delay allowed value of 15000
	 * ms.
	 *
	 * @param writeLimit
	 *            0 or a limit in bytes/s
	...
	/**
	 * Create a new instance using default Check Interval value of 1000 ms and max
	 * time as delay allowed value of 15000 ms.
	 *
	 * @param writeLimit
	 *            0 or a limit in bytes/s
	 * @param readLimit
